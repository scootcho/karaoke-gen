...
@patch("karaoke_gen.utils.gen_cli.run_combined_review", return_value=("selected_instrumental.flac", None, False))
...
@patch("karaoke_gen.utils.gen_cli.run_combined_review", return_value=("clean", None, False))
@patch("karaoke_gen.utils.gen_cli.is_url", return_value=False)
@patch("karaoke_gen.utils.gen_cli.is_file", return_value=False)
@patch("karaoke_gen.utils.gen_cli.KaraokePrep")
