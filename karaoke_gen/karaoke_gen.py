...
class KaraokePrep:
    ...
    async def prep_single_track(self):
        ...
        try:
            ...
            if self.render_video and not self.file_handler._file_exists(processed_track["title_video"]) and not os.environ.get("KARAOKE_GEN_SKIP_TITLE_END_SCREENS"):
            ...
            # Use FileHandler._file_exists
            if self.render_video and not self.file_handler._file_exists(processed_track["end_video"]) and not os.environ.get("KARAOKE_GEN_SKIP_TITLE_END_SCREENS"):
